...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Nikhil Srivastava
            <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
            ...
            <div className="home__description">I breathe life into code and thrive on the excitement of solving complex problems. My journey in the world of software development has been fueled by an insatiable curiosity and a passion for creating meaningful and efficient solutions. My passion for problem-solving drives me to continually learn and evolve in the ever-changing landscape of technology.</div>
            <div className="home__description">
            If you share my passion for innovative problem-solving and cutting-edge technology, let's connect and explore the possibilities together.
            </div>

            <div className="home__social2-div">
            <div className="home__social2">
