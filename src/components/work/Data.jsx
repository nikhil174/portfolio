export const projectsData = [
    {
        ...
        title: 'Qkart',
        category: 'frontend',
        demo: 'https://nikhil-qkart-frontend.netlify.app',
        description: 'A Shopping Web App',
    ...
    },
    {
        ...
        title: 'Admin UI',
        category: 'frontend',
        description: 'An app to show data in table with pagination, search and filter functionality',
        tech: ['ReactJS', 'Material-UI'],
        demo: 'https://silver-bunny-698c7e.netlify.app/',
        github: 'https://github.com/nikhil174/data-table'
    }
]
