...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    if (loading) {
      return; // Prevent sending another request while the previous one is still in progress
    }
        ...
        <div className="contact__content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">nikhilsrivastavaone@gmail.com</span>
            </div>

            <div className="contact__card">
              <i className="bx bxl-whatsapp contact__card-icon"></i>
              <h3 className="contact__card-title">Whatsapp</h3>
              <span className="contact__card-data">+91 7843957959</span>
            </div>
          </div>
        </div>
        ...
        <div className="contact__content">
          ...
          <form ref={form} onSubmit={sendEmail} className="contact__form">
            ...
            <button className="button button--flex" type="submit" disabled={loading}>
              {loading && <i className="bx bx-loader-alt bx-spin"></i>} <span className='contact_btn_Text'>Send Message</span>
            </button>
            {/* <button>
                <path
